...
class Run
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_woodmart_ajax_add_to_cart', function (){
        ...
        add_action('wp_ajax_woodmart_add_to_wishlist', function (){
        ...
        add_action('wp_ajax_woodmart_remove_from_wishlist', function (){
            if(isset($_REQUEST['product_id']))
            {
